...
headingDegrees, stance} objects, where targetType is "area" or "climb" and
...
baked into the shipped db). stance ("base" or "top"; default base for older exports). headingDegrees (0-360, 0=north, or null if no
