...
@Database(entities = [AreaEntity::class, ClimbEntity::class, CliffCorridorEntity::class], version = 3, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    abstract fun areaDao(): AreaDao
    abstract fun climbDao(): ClimbDao
    abstract fun cliffCorridorDao(): CliffCorridorDao
