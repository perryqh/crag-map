...
- **Basemap**: USGS ImageryTopo + NAIP (z13–18) and classic USGS Topo (z13–16), both public domain and bundled. **Map settings** (overflow ⋮): show/hide hockey-puck labels, switch Imagery vs Topo. `tools/build_mbtiles.py` fetches tiles for a bounding box/zoom range into a standard MBTiles package.
